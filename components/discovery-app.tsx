...
export function DiscoveryApp() {
  ...
  return (
    <main>
      ...
      <footer><div className="brand-social"><a className="brand" href="#top"><img className="brand-logo-image" src="/csb-coin-logo.png" alt=""/><span>Crypto Sugar Babes</span></a><InstagramLink/><XLink/></div><p className="footer-copyright">© 2026 Crypto Sugar Babes. Safety First Always.</p><div className="footer-links"><a href="/how-it-works">How it works</a><a href="/crypto-safety">Crypto safety</a><a href="/crypto-payments">USDC payments</a><a href="/forums">Forums</a><a href="/safety">Safety</a><a href="/disputes">Disputes</a><a href="/terms">Terms</a><a href="/privacy">Privacy</a></div></footer>
