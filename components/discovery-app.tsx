        ...
        return <div className="modal-backdrop" role="presentation" onMouseDown={(event) => { if (event.target === event.currentTarget) setActiveProfile(null); }}>
          <section className="profile-modal" role="dialog" aria-modal="true" aria-labelledby="profile-modal-title">
            ...
            <div className="modal-content">
              ...
              {accountType === "CUSTOMER" && <div className="generosity-badge"><Icon name="spark" size={19}/><span>Your Sugar Rating: {formatMonthlySugarRating(monthlySupportGivenUsdc)}</span><strong>{sugarDaddyMonthlyLevel(monthlySupportGivenUsdc).name} · This month</strong></div>}
