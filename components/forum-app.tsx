...
export default function ForumApp() {
  ...
  return <main className="forum-shell">
    ...
    <footer className="forum-footer"><div className="brand-social"><a className="brand" href="/"><img className="brand-logo-image" src="/csb-coin-logo.png" alt=""/><span>Crypto Sugar Babes</span></a><InstagramLink/><XLink/></div><span>© 2026 Crypto Sugar Babes. Safety First Always.</span><nav><a href="/crypto-safety">Crypto safety</a><a href="/safety">Safety</a><a href="/disputes">Disputes</a><a href="/anti-slavery">Anti-Slavery</a><a href="/anti-trafficking">Anti-Trafficking</a><a href="/consumer-protection">Consumer Protection</a><a href="/terms">Terms</a><a href="/privacy">Privacy</a></nav></footer>
  </main>;
}
