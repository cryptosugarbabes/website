...
type ReviewProfile = { id: string; name: string; age: number; city: string; country: string; headline: string; bio: string; interests: string[]; status: string; reviewed: boolean; rejectionReason?: string; photos: Array<{ id: string; url: string; approved: boolean; reviewed: boolean }> };
