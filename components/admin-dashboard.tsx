...
type AdminTab = "overview" | "profiles" | "accounts" | "conversations" | "notifications" | "payments" | "reports" | "audit";
...
export function AdminDashboard() {
  ...
  async function loadDashboard() { const active = await loadProfiles(); if (active) await Promise.all([loadReports(), loadOperations(), loadConversations(), loadMessageAlerts()]); }
