    ...
    sections={[
      {
        ...
        items: [
          ...
          "Pop-up chat messages, the page where chat was opened, a hashed network identifier used for rate limiting, administrator or Telegram replies, the associated member account when signed in, and an email address when provided for support follow-up.",
          "When paid features launch, transaction identifiers, amounts, ledger entries, Sugar Babe balances, and payout records."
        ]
      },
      {
        ...
        items: [
          ...
          "Operate conversations, favorites, paid interactions, Sugar Babe earnings, and platform fees when those features are available.",
          "Notify administrators that a guest or logged-in member is on the website, associate available account or visitor-provided contact details with that support conversation, and deliver support through the administrator dashboard, email, and the configured private Telegram bot.",
