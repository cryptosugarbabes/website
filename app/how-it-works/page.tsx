    ...
    sections={[
      {
        ...
        paragraphs: [
          ...
          "Creators can prepare a profile with a display name, location, biography, interests, and photographs. Publication remains subject to safety review, reports, suspension, and removal.",
        ],
      },
      {
